...
test.describe("Make Appointment", () => {
    ...
    *    you can move step by step from the window pop-up. you can also use the "pause()" [line 40 on our code, cancel comment] method in your test code to pause the test execution at a specific point and inspect the state of the application.
